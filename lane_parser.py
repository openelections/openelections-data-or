...
offices = ['United States President', 'US Senator', 'US Representative, 4th District', 'Representative in Congress, 4th District', 'State Representative, 7th District', 'State Representative, 8th District',
...
'State Treasurer', 'Attorney General', 'Secretary of State', 'State Senator, 1st District', 'State Senator, 2nd District', 'Representative, Congress, 4th District', 'United States President and VP',
'Representative, Congress 4th Dist. 4TH DISTRICT', 'Representative, Congress 2nd Dist. 2ND DISTRICT', 'State Senator, 4th District', 'State Senator, 6th District', 'State Senator, 7th District', ]
office_lookup = {
...
with open('20141104__or__general__lane__precinct.csv', 'wb') as csvfile:
    w = unicodecsv.writer(csvfile, encoding='utf-8')
    w.writerow(headers)

    r = requests.get("http://www.lanecounty.org/Departments/CAO/Operations/CountyClerk/elections/ElectionDocuments/20141104_FinalCanvas.HTM")
