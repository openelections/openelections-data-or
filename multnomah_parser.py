...
with open('20121106__or__general__multnomah__precinct.csv', 'wb') as csvfile:
    w = unicodecsv.writer(csvfile, encoding='utf-8')
    w.writerow(headers)

    r = requests.get('https://multco.us/elections/november-2012-general-election-abstract-votes-precinct-level')
